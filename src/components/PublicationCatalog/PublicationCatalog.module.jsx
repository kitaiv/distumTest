...
import PublicationItem from './PublicationItem.module'

class PublicationCatalog extends React.Component{
    render(){
        return(
            <>
            <nav className="nav">
                <div className="container">
                    ...
                    <span className="nav__current">Каталог публикаций</span>
                </div>
            </nav>
                        ...
                        <div className="content__wrapper">
                            <div className="catalog__wrapper">
                                ...
                                <PublicationItem items={[
                                    {
                                        title: 'Животный мир',
                                        subTitle: 'Сайт рыбатекст поможет дизайнеру, верстальщику, вебмастеру сгенерировать несколько абзацев. Сайт рыбатекст поможет дизайнеру.',
                                        author: 'Ковальчук Наталья Геннадьевна'
                                    },
                                    {
                                        title: 'Животный мир',
                                        subTitle: 'Сайт рыбатекст поможет дизайнеру, верстальщику, вебмастеру сгенерировать несколько абзацев. Сайт рыбатекст поможет дизайнеру.',
...
export default PublicationCatalog