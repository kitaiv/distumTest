...
import WebinarItem from './WebinarItem.module'

class WebinarCatalog extends React.Component{
    render(){
        return(
            <>
                <nav className="nav">
                    <div className="container">
                        ...
                        <span className="nav__current">Вебинары</span>
                    </div>
                </nav>
                        ...
                        <div className="container">
                            ...
                            <div className="content__wrapper">
                                ...
                                <WebinarItem items={[
                                    ...
                                    {
                                        img: 'https://www.careergro.com/images/usa-img.jpg',
                                        title: 'Вебинар литература и русский язык'
                                    },
                                    {
                                        img: 'https://www.careergro.com/images/usa-img.jpg',
                                        title: 'Животный мир'
