...
import ProgramItem from './ProgramItem.module'

class WorkingProgramsCatalog extends React.Component{
    render(){
        return(
            <>
                <nav className="nav">
                    <div className="container">
                        ...
                        <span className="nav__current">Каталог рабочих программ</span>
                    </div>
                </nav>
                ...
                <main>
                    <section className="main">
                        <div className="container">
                            <h1>Каталог рабочих программ</h1>
                            <div className="content__wrapper">
                                ...
                                <div className="sidebar-pagen">
                                    <ul>
                                        ...
                                        <li className="sidebar-pagen__item sidebar-pagen__item_next"><span></span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
export default WorkingProgramsCatalog